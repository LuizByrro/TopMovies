package com.luizbyrro.topmovies.custom;
 ...
 */
public class CustomRecyclerView extends LinearLayoutManager {

    public CustomRecyclerView(Context context) {
        super(context, VERTICAL, false);
    }

    public CustomRecyclerView(Context context, int orientation, boolean reverseLayout) {
